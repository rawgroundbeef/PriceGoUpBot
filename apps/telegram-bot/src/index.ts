...
import { container, getInitializationState, setInitializationState } from './ioc-container';
...
async function initializeServices() {
  ...
  try {
    ...
    const priceGoUpBot = container.get<PriceGoUpBotService>(TYPES.PriceGoUpBotService);
