...
// Bind core services
container
  .bind<IErrorService>(TYPES.ErrorService)
  .to(ErrorService)
  .inSingletonScope();
container
  ...
  .inSingletonScope();
container
  .bind<SupabaseService>(TYPES.SupabaseService)
  .to(SupabaseService)
  .inSingletonScope();

// Bind business services
container
  .bind<IVolumeOrderService>(TYPES.VolumeOrderService)
  .to(VolumeOrderService)
  .inSingletonScope();
container
  .bind<ISolanaService>(TYPES.SolanaService)
  .to(SolanaService)
  .inSingletonScope();
container
  .bind<IVolumeEngineService>(TYPES.VolumeEngineService)
  .to(VolumeEngineService)
  .inSingletonScope();
container
  ...
  .inSingletonScope();
container
  .bind<SweeperService>(TYPES.SweeperService)
  .to(SweeperService)
  .inSingletonScope();
container
  .bind<JupiterTradingService>(TYPES.JupiterTradingService)
  .to(JupiterTradingService)
  .inSingletonScope();

// Bind the main bot service
container
  .bind<PriceGoUpBotService>(TYPES.PriceGoUpBotService)
  .to(PriceGoUpBotService)
  .inSingletonScope();
