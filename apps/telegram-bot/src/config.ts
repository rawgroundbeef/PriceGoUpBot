...
export const SOLANA_RPC_URL = getEnv(
  "SOLANA_RPC_URL",
...
export const TREASURY_OPERATIONS_ADDRESS = requireEnv(
  "TREASURY_OPERATIONS_ADDRESS",
);

// Fee Configuration
export const FEE_BPS = parseInt(getEnv("FEE_BPS", "500") || "500", 10);
export const MIN_SWEEP_LAMPORTS = parseInt(
  getEnv("MIN_SWEEP_LAMPORTS", "1000000") || "1000000",
  10,
);
...
export function validateEnvironment() {
  ...
  try {
    ...
    console.log(
      `🏦 Fees treasury: ${TREASURY_FEES_ADDRESS.substring(0, 8)}...`,
    );
    console.log(
      `🏦 Ops treasury: ${TREASURY_OPERATIONS_ADDRESS.substring(0, 8)}...`,
    );
